...
export const en: TranslationKeys = {
  ...
  auth: {
    ...
    register: {
      ...
      subtitle: "Join the BattleCorp universe",
      username: "Username",
      email: "Email",
      password: "Password",
      ...
      usernameHelp: "3-30 characters, alphanumeric",
      passwordHelp: "Minimum 8 characters with 3 types (upper, lower, digit, special)",
    },
    passwordReset: {
      ...
      tokenSubtitle: "Enter your new password",
      newPassword: "New password",
      confirmPassword: "Confirm password",
      submitToken: "Reset password",
      tokenLoading: "Resetting password...",
      tokenSuccess: "Password reset successful! Redirecting...",
      tokenError: "Failed to reset password",
      invalidToken: "This reset link is invalid or has expired",
    },
    emailValidation: {
      title: "Verify Email",
      subtitle: "Confirming your email address",
      validating: "Verifying your email...",
    ...
    errors: {
      "Created account": "Please verify your email before logging in",
      "Banned account": "Your account has been banned",
      "Disabled account": "Your account has been disabled",
      "InvalidCredentials": "Invalid email or password",
      "CouldNotReachServer": "Unable to reach the server",
      "UnknownServerError": "An unknown error occurred",
      "GenericErrorMessage": "Something went wrong",
    },
    passwordValidation: {
      PasswordErrorMinLength: "Password must be at least 8 characters",
      PasswordErrorTypes: "Password must contain at least 3 types: uppercase, lowercase, digit, or special character",
    },
    account: {
      logout: "Logout",
