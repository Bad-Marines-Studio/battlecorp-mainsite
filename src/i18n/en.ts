...
export const en: TranslationKeys = {
        ...
        list: [
          {
            ...
            tactical: {
              strengths: "Low-cost frontline presence.",
              weaknesses: "Limited damage and no ranged attack.",
              usage: "Hold lines and absorb pressure while heavier units arrive.",
            },
          },
          {
            id: "commando",
            ...
            tactical: {
              strengths: "High melee burst against priority targets.",
              weaknesses: "Fragile and expensive to sustain.",
              usage: "Use for breakthroughs and quick eliminations.",
            },
          },
          {
            id: "cyborg",
            ...
            tactical: {
              strengths: "Very fast production and low fabrication cost.",
              weaknesses: "Average combat impact per unit.",
              usage: "Mass-produce to saturate fronts and secure territory.",
            },
          },
          {
            id: "tank",
            ...
            tactical: {
              strengths: "Durable spearhead with strong melee pressure.",
              weaknesses: "Slow production and high energy upkeep.",
              usage: "Lead assaults and anchor contested zones.",
            },
          },
          {
            id: "artillery",
            ...
            tactical: {
              strengths: "Extreme ranged damage from safe distance.",
              weaknesses: "Weak in close combat and fragile when exposed.",
              usage: "Soften targets before advancing ground forces.",
            },
          },
          {
            id: "bomber",
            ...
            tactical: {
              strengths: "Strong strike potential on strategic targets.",
              weaknesses: "Vulnerable if not escorted.",
              usage: "Disrupt enemy backline and infrastructure.",
            },
          },
          {
            id: "fighter",
            ...
            tactical: {
              strengths: "Balanced air control and interception.",
              weaknesses: "Lower raw damage than bombers.",
              usage: "Escort bombers and deny enemy air operations.",
            },
          },
        ],
        production: {
  ...
  auth: {
    ...
    signup: {
      ...
      success: "Account created. Check your email to validate your account.",
      successRedirect: "Redirecting to login...",
    },
    passwordReset: {
      title: "Reset password",
      tokenTitle: "Choose a new password",
      email: "Email",
      ...
      tokenLoading: "Updating password...",
      tokenError: "Unable to reset password.",
      tokenSuccess: "Your password has been changed successfully.",
    },
    emailValidation: {
      ...
      redirect: "Redirecting to login...",
      error: "Unable to validate your email.",
      invalidToken: "Invalid validation link.",
    },
    passwordValidation: {
      PasswordErrorMinLength: "Minimum 8 characters",
      PasswordErrorTypes: "Use at least 3 character types",
    },
    account: {
      profile: "Profile",
      ...
      emailChangeButton: "Update email",
      emailChangeSuccess: "Email updated. Check your inbox to confirm.",
      emailChangeSimilarError: "This email is already in use.",
      forbiddenDomain: "This email domain is not allowed.",
      passwordChangeTitle: "Change password",
      currentPassword: "Current password",
      newPassword: "New password",
      confirmPassword: "Confirm new password",
      passwordChangeButton: "Update password",
      passwordChangeSuccess: "Password updated. Please log in again.",
      dangerZoneTitle: "Danger zone",
      accountDeletionButton: "Delete my account",
      accountDeletionWarning: "This action is irreversible. Your account will be permanently deleted.",
      accountDeletionSuccess: "Account deleted. Redirecting...",
      logout: "Log out",
